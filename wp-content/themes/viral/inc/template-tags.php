...
function viral_posted_on() {
	...
	echo '<span class="entry-date published updated">' . $posted_on . '</span><span class="byline"> ' . $byline . '</span>';
...
function viral_social_share(){
	...
	$content .= '<span>'. __( 'COMPARTILHE:', 'viral' ) .'</span>';
    $content .= '<a title="'.__('Share on Facebook', 'viral').'" href="'.$facebookURL.'" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>';
    $content .= '<a title="'.__('Share on Twitter', 'viral').'" href="'. $twitterURL .'" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>';
    $content .= '<a title="'.__('Email', 'viral').'" href="'.$mailURL.'"><i class="fa fa-envelope" aria-hidden="true"></i></a>';
    $content .= '</div>';
